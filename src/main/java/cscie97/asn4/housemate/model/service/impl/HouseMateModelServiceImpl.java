package cscie97.asn4.housemate.model.service.impl;

import cscie97.asn4.housemate.entitlement.AccessToken;
import cscie97.asn4.housemate.entitlement.Resource;
...
import cscie97.asn4.housemate.model.Device;
import cscie97.asn4.housemate.model.House;
import cscie97.asn4.housemate.model.Occupant;
import cscie97.asn4.housemate.model.Room;
import cscie97.asn4.housemate.model.appliance.Ava;
import cscie97.asn4.housemate.model.listener.DeviceStatusChangeListener;
...
import cscie97.asn4.housemate.model.support.HouseOccupant;
...
public class HouseMateModelServiceImpl implements HouseMateModelService {
    ...
    public void defineHouse(AccessToken accessToken, String houseIdentifier) throws EntityExistsException, AccessDeniedException, InvalidAccessTokenException {
        ...
        } catch (cscie97.asn4.housemate.entitlement.exception.EntityExistsException e) {
