...
/**
 * This command should be executed when Ava is asked to turn on lights.
 */
public class AvaLightsOnCommand extends ControllerCommand {

    private final String houseId;

    private final String roomId;

    public AvaLightsOnCommand(AccessToken accessToken, String houseId, String roomId) {
        super(accessToken);
    ...
    /**
     * This method retrieves all light appliances in this Ava's room, and sets their MODE to ON.
     */
    @Override
