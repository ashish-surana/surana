...
import cscie97.asn4.housemate.core.init.exception.InitializationException;
import cscie97.asn4.housemate.entitlement.AccessToken;
import cscie97.asn4.housemate.entitlement.exception.AuthenticationException;
...
import cscie97.asn4.housemate.exe.HouseMateServiceExecutor;
...
/**
 * This class is a test driver for {@link cscie97.asn4.housemate.model.service.HouseMateModelService}.
 */
public class TestDriver {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        try {
            ...
            while (true) {
                ...
                //For now, read next file path and execute file
                printUsage();
    ...
    private static void executeCommandsFromFile(String configFilePath){
        try {
            ...
            System.out.println(message);
        } catch (cscie97.asn4.housemate.entitlement.exception.EntityNotFoundException e) {
            String message = "Error executing a command on entity with id: '"+ e.getEntity();
            message += "'. Error message is: '"+ e.getMessage()+"'.";
            System.out.println(message);
