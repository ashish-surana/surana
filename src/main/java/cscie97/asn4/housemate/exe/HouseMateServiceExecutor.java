package cscie97.asn4.housemate.exe;
...
import cscie97.asn4.housemate.exe.command.factory.CommandFactory;
 ...
 * This class looks up the appropriate {@link cscie97.asn4.housemate.exe.command.Command} by using
        ...
        try{
            ...
            while((nextLine = bufferedReader.readLine()) != null){
                ...
                try{
                    ...
                    message += " Command was read from file: '" + fileName + "' at line :" + lineNum + ".";
                    System.out.println(message);
                } catch (cscie97.asn4.housemate.entitlement.exception.EntityException e) {
                    String message = "Error executing a command on entity: '"+ e.getEntity();
                    message += "'. Error message is: '"+ e.getMessage()+"'.";
                    message += " Command was read from file: '" + fileName + "' at line :" + lineNum + ".";
                    System.out.println(message);
