...
public class ResourceCommand extends Command {
    ...
    @Override
    protected void executeDefineCommand(CommandParser commandParser) throws InvalidCommandException, EntityExistsException, EntityNotFoundException, InvalidEntityTypeException, cscie97.asn4.housemate.entitlement.exception.EntityExistsException {
